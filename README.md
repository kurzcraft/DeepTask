...
<p align="center">
  <a href="https://github.com/kurzcraft/DeepTask/releases/latest"><strong>下载 Deeptask 5.5.8</strong></a>
  ·
  <a href="#三分钟开始">快速开始</a>
  ·
...
> **Deeptask 5.5.8** 基于 Kilo Code 5.5 成熟架构持续演进，专注解决长程 Agent
...
1. 从 [GitHub Releases](https://github.com/kurzcraft/DeepTask/releases/latest) 下载 `deeptask-5.5.8.vsix`。
2. 安装到 VSCodium：
