...
python3 scripts_patch_git_commit_chinese_dist.py
python3 scripts_patch_command_output_immediate_feedback_dist.py
bash scripts_package_deeptask_vsix.sh
python3 scripts_verify_command_output_message_visible_vsix.py
python3 scripts_verify_command_output_force_continue_send_vsix.py
python3 scripts_verify_git_commit_entry_vsix.py
python3 scripts_verify_deeptask_wildcard_auto_approval_vsix.py
