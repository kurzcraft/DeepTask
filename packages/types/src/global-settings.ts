...
export const globalSettingsSchema = z.object({
	...
	taskProgressFileEnabled: z.boolean().optional(), // kilocode_change
	...
	terminalCompletedTerminalLimitEnabled: z.boolean().optional(), // kilocode_change
	terminalCompletedTerminalLimit: z.number().optional(), // kilocode_change
...
export const EVALS_SETTINGS: RooCodeSettings = {
	...
	terminalCompletedTerminalLimitEnabled: true, // kilocode_change
	terminalCompletedTerminalLimit: 3, // kilocode_change
	...
	// kilocode_change start - Task progress file default
	taskProgressFileEnabled: true,
	// kilocode_change end
