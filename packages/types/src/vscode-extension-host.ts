...
export type ExtensionState = Pick<
	...
	| "pinnedApiConfigs"
	| "customInstructions"
	| "taskProgressFileEnabled" // kilocode_change
	| "dismissedUpsells"
	| "autoApprovalEnabled"
	| "yoloMode" // kilocode_change
	| "alwaysAllowReadOnly"
	...
	| "terminalCompletedTerminalLimitEnabled" // kilocode_change
	| "terminalCompletedTerminalLimit" // kilocode_change
...
export interface WebviewMessage {
	...
	askTs?: number // kilocode_change: bind ask responses to the originating ask row
	apiConfiguration?: ProviderSettings
	images?: string[]
	bool?: boolean
	value?: number
	...
	terminalOperationText?: string // kilocode_change
	terminalOperationImages?: string[] // kilocode_change
	messageTs?: number
