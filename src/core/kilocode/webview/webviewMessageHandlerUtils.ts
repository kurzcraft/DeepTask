...
const resendMessageSequence = async (
	...
	currentCline.terminalProcess?.abort()
	...
	// kilocode_change start
	newCline.messageQueueService.clear()
	newCline.clearStaleWebviewAskResponse()
	await newCline.submitUserMessage(editedText, images)
	// kilocode_change end
