...
describe("Condense", () => {
	...
	describe("summarizeConversation", () => {
		it("should preserve the first message when summarizing", async () => {
			...
			// Verify we have a summary message without synthetic reasoning leakage
			...
			expect(contentArray).toEqual([{ type: "text", text: "Mock summary of the conversation" }])
			expect(contentArray.some((block) => (block as any).type === "reasoning")).toBe(false)
