					...
					<SearchIndexProvider value={searchContextValue}>
						...
						{activeTab === "checkpoints" && (
							<CheckpointSettings
								...
								taskProgressFileEnabled={taskProgressFileEnabled}
						...
						{activeTab === "terminal" && (
							<TerminalSettings
								...
								terminalCompletedTerminalLimitEnabled={terminalCompletedTerminalLimitEnabled}
								terminalCompletedTerminalLimit={terminalCompletedTerminalLimit}
