			...
			<Section>
				...
				<div className="flex flex-col gap-3">
					...
					<div className="flex flex-col gap-3 pl-3 border-l-2 border-vscode-button-background">
						<SearchableSetting
							settingId="terminal-completed-terminal-limit"
							section="terminal"
							label={t("settings:terminal.completedTerminalLimit.label")}>
							<VSCodeCheckbox
								checked={terminalCompletedTerminalLimitEnabled ?? true}
								onChange={(e: any) =>
									setCachedStateField("terminalCompletedTerminalLimitEnabled", e.target.checked)
								}
								data-testid="terminal-completed-terminal-limit-enabled-checkbox">
								<span className="font-medium">
									{t("settings:terminal.completedTerminalLimit.label")}
								</span>
							</VSCodeCheckbox>
							<div className="flex items-center gap-2 mt-2">
								<Slider
									...
									max={20}
									step={1}
									value={[terminalCompletedTerminalLimit ?? 3]}
									onValueChange={([value]) =>
										setCachedStateField(
											"terminalCompletedTerminalLimit",
									...
									data-testid="terminal-completed-terminal-limit-slider"
								/>
								<span className="w-10">{terminalCompletedTerminalLimit ?? 3}</span>
							</div>
							<div className="text-vscode-descriptionForeground text-sm mt-1">
								{t("settings:terminal.completedTerminalLimit.description")}
							</div>
						</SearchableSetting>
						<SearchableSetting
