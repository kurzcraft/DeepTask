...
describe("ChatView - Notification Sound", () => {
	beforeEach(() => vi.clearAllMocks())

	it("plays celebration sound when completion_result is received even with stale queue state", async () => {
		renderChatView()
	...
	it("plays celebration sound when completion_result is received", async () => {
		renderChatView()
