	...
	switch (message.type) {
		case "say":
			switch (message.say) {
							...
							<div
								className={cn(
									...
									isEditing
										...
										: "cursor-pointer bg-vscode-editor-background text-vscode-foreground",
								)}>
								{isEditing ? (
									...
									<div className="flex justify-between">
										<div
											...
											title={t("chat:editMessage.placeholder")}>
				...
				case "error":
					// kilocode_change start: Deeptask does not expose Kilo account or support flows.
