...
import { appendSessionMessageAtom } from "../state/atoms/messages"
...
export const ChatInput: React.FC<ChatInputProps> = ({
	...
	const appendSessionMessage = useSetAtom(appendSessionMessageAtom)
		...
		if (isSessionCompleted) {
			...
			appendSessionMessage({
				...
				message: {
					...
					text: trimmedMessage || "",
					images,
					metadata: { agentManagerOptimisticUserFeedback: true } as ClineMessage["metadata"],
				},
			})
			vscode.postMessage({
